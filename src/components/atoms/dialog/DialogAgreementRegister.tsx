      ...
      <DialogContent>
        ...
        <div className="text-muted-foreground space-y-3 text-sm">
          <div>
            ...
            berpartisipasi dalam penelitian berbasis website ini &quot;Dialisis
            Connect Edu&quot; dengan penuh kesadaran dan tanpa ada paksaan dari
          ...
          <ol className="ml-4 list-decimal space-y-1">
            ...
            <li>
              Saya berhak untuk mengundurkan diri dari penelitian ini kapan saja
              tanpa perlu memberikan alasan apa pun.
            </li>
          </ol>
